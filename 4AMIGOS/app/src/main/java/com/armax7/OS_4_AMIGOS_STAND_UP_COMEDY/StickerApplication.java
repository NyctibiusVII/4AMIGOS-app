...
public class StickerApplication extends Application {
    ...
    public void onCreate() {
        ...
        , k = getString(R.string.sequencia_kk), nd3 = getString(R.string.m19), o = getString(R.string.i15xama), p = getString(R.string.j16)
        , j = getString(R.string.k17null), z = getString(R.string.l18), n = getString(R.string.h14), t = getString(R.string.n20)
